...
export default function GestionDisponibilidades() {
  ...
  if (loadingOdontologos || loadingDisponibilidades || loadingTurnos) {
    return (
      <div className="pacientes-loader" style={{ height: '80vh' }}>
        <Lottie animationData={loadingAnim} loop autoplay style={{ width: 220 }} />
        <p style={{ marginTop: '1.5rem', fontWeight: '850', color: '#145c63', fontSize: '1.3rem' }}>
          Cargando disponibilidades y turnos...
        </p>
      </div>
    );
  }
    ...
    <div className="gestion-disponibilidades-container">
      ...
      {isFetching && (
        <div className="pacientes-loader" style={{
          ...
          <p style={{ marginTop: '1rem', fontWeight: '850', color: '#145c63' }}>Actualizando disponibilidades...</p>
        </div>
      )}
